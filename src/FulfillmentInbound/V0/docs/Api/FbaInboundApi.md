# TNT\Amazon\FulfillmentInbound\V0\FbaInboundApi
...
# **confirmPreorder**
> \TNT\Amazon\FulfillmentInbound\V0\Model\ConfirmPreorderResponse confirmPreorder($shipment_id, $need_by_date, $marketplace_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\ConfirmPreorderResponse**](../Model/ConfirmPreorderResponse.md)
...
# **confirmTransport**
> \TNT\Amazon\FulfillmentInbound\V0\Model\ConfirmTransportResponse confirmTransport($shipment_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\ConfirmTransportResponse**](../Model/ConfirmTransportResponse.md)
...
> \TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentResponse createInboundShipment($body, $shipment_id)
...
$body = new \TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentRequest(); // \TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentRequest | 
$shipment_id = "shipment_id_example"; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentRequest**](../Model/InboundShipmentRequest.md)|  |
 **shipment_id** | **string**| A shipment identifier originally returned by the createInboundShipmentPlan operation. |

### Return type

[**\TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentResponse**](../Model/InboundShipmentResponse.md)
...
> \TNT\Amazon\FulfillmentInbound\V0\Model\CreateInboundShipmentPlanResponse createInboundShipmentPlan($body)
...
$body = new \TNT\Amazon\FulfillmentInbound\V0\Model\CreateInboundShipmentPlanRequest(); // \TNT\Amazon\FulfillmentInbound\V0\Model\CreateInboundShipmentPlanRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TNT\Amazon\FulfillmentInbound\V0\Model\CreateInboundShipmentPlanRequest**](../Model/CreateInboundShipmentPlanRequest.md)|  |

### Return type

[**\TNT\Amazon\FulfillmentInbound\V0\Model\CreateInboundShipmentPlanResponse**](../Model/CreateInboundShipmentPlanResponse.md)
...
# **estimateTransport**
> \TNT\Amazon\FulfillmentInbound\V0\Model\EstimateTransportResponse estimateTransport($shipment_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\EstimateTransportResponse**](../Model/EstimateTransportResponse.md)
...
# **getBillOfLading**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetBillOfLadingResponse getBillOfLading($shipment_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetBillOfLadingResponse**](../Model/GetBillOfLadingResponse.md)
...
# **getInboundGuidance**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetInboundGuidanceResponse getInboundGuidance($marketplace_id, $seller_sku_list, $asin_list)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetInboundGuidanceResponse**](../Model/GetInboundGuidanceResponse.md)
...
# **getLabels**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetLabelsResponse getLabels($shipment_id, $page_type, $label_type, $number_of_packages, $package_labels_to_print, $number_of_pallets, $page_size, $page_start_index)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetLabelsResponse**](../Model/GetLabelsResponse.md)
...
# **getPreorderInfo**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetPreorderInfoResponse getPreorderInfo($shipment_id, $marketplace_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetPreorderInfoResponse**](../Model/GetPreorderInfoResponse.md)
...
# **getPrepInstructions**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetPrepInstructionsResponse getPrepInstructions($ship_to_country_code, $seller_sku_list, $asin_list)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetPrepInstructionsResponse**](../Model/GetPrepInstructionsResponse.md)
...
# **getShipmentItems**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetShipmentItemsResponse getShipmentItems($query_type, $marketplace_id, $last_updated_after, $last_updated_before, $next_token)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetShipmentItemsResponse**](../Model/GetShipmentItemsResponse.md)
...
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetShipmentItemsResponse getShipmentItemsByShipmentId($shipment_id, $marketplace_id)
...
# **getShipments**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetShipmentsResponse getShipments($query_type, $marketplace_id, $shipment_status_list, $shipment_id_list, $last_updated_after, $last_updated_before, $next_token)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetShipmentsResponse**](../Model/GetShipmentsResponse.md)
...
# **getTransportDetails**
> \TNT\Amazon\FulfillmentInbound\V0\Model\GetTransportDetailsResponse getTransportDetails($shipment_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\GetTransportDetailsResponse**](../Model/GetTransportDetailsResponse.md)
...
# **putTransportDetails**
> \TNT\Amazon\FulfillmentInbound\V0\Model\PutTransportDetailsResponse putTransportDetails($shipment_id, $body)
...
$shipment_id = "shipment_id_example"; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
$body = new \TNT\Amazon\FulfillmentInbound\V0\Model\PutTransportDetailsRequest(); // \TNT\Amazon\FulfillmentInbound\V0\Model\PutTransportDetailsRequest | 
...
------------- | ------------- | ------------- | -------------
 **shipment_id** | **string**| A shipment identifier originally returned by the createInboundShipmentPlan operation. |
 **body** | [**\TNT\Amazon\FulfillmentInbound\V0\Model\PutTransportDetailsRequest**](../Model/PutTransportDetailsRequest.md)|  |

### Return type

[**\TNT\Amazon\FulfillmentInbound\V0\Model\PutTransportDetailsResponse**](../Model/PutTransportDetailsResponse.md)
...
> \TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentResponse updateInboundShipment($body, $shipment_id)
...
# **voidTransport**
> \TNT\Amazon\FulfillmentInbound\V0\Model\VoidTransportResponse voidTransport($shipment_id)
...
[**\TNT\Amazon\FulfillmentInbound\V0\Model\VoidTransportResponse**](../Model/VoidTransportResponse.md)
