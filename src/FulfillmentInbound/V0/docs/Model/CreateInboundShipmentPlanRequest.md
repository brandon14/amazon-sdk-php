...
------------ | ------------- | ------------- | -------------
**ship_from_address** | [**\TNT\Amazon\FulfillmentInbound\V0\Model\Address**](Address.md) | The address from which the inbound shipment will be sent. | 
**label_prep_preference** | [**\TNT\Amazon\FulfillmentInbound\V0\Model\LabelPrepPreference**](LabelPrepPreference.md) | The seller&#39;s preference for label preparation for an inbound shipment. | 
...
**inbound_shipment_plan_request_items** | [**\TNT\Amazon\FulfillmentInbound\V0\Model\InboundShipmentPlanRequestItemList**](InboundShipmentPlanRequestItemList.md) |  | 
