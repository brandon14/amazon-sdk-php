...
# **getOrderMetrics**
> \TNT\Amazon\Sales\V1\Model\GetOrderMetricsResponse getOrderMetrics($marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku)
...
------------- | ------------- | ------------- | -------------
 **marketplace_ids** | [**string[]**](../Model/string.md)| A marketplace identifier. This specifies the marketplace in which the order was placed. Only one marketplace can be specified.  For example, ATVPDKIKX0DER indicates the US marketplace. |
...
[**\TNT\Amazon\Sales\V1\Model\GetOrderMetricsResponse**](../Model/GetOrderMetricsResponse.md)
