...
**item_unfulfillable_reasons** | [**\TNT\Amazon\FulfillmentOutbound\V20200701\Model\StringList**](StringList.md) | Error codes associated with the fulfillment order preview that indicate why the item is unfulfillable. | [optional] 
