...
**contributors** | [**\TNT\Amazon\CatalogItems\V20220401\Model\ItemContributor[]**](ItemContributor.md) | Individual contributors to the creation of an item, such as the authors or actors. | [optional] 
...
**release_date** | [**\DateTime**](\DateTime.md) | First date on which an Amazon catalog item is shippable to customers. | [optional] 
