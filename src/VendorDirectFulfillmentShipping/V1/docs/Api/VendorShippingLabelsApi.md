# TNT\Amazon\VendorDirectFulfillmentShipping\V1\VendorShippingLabelsApi
...
# **getShippingLabel**
> \TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\GetShippingLabelResponse getShippingLabel($purchase_order_number)
...
$apiInstance = new TNT\Amazon\VendorDirectFulfillmentShipping\V1\Api\VendorShippingLabelsApi(
...
[**\TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\GetShippingLabelResponse**](../Model/GetShippingLabelResponse.md)
...
# **getShippingLabels**
> \TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\GetShippingLabelListResponse getShippingLabels($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token)
...
[**\TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\GetShippingLabelListResponse**](../Model/GetShippingLabelListResponse.md)
...
> \TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\SubmitShippingLabelsResponse submitShippingLabelRequest($body)
...
$body = new \TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\SubmitShippingLabelsRequest(); // \TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\SubmitShippingLabelsRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\SubmitShippingLabelsRequest**](../Model/SubmitShippingLabelsRequest.md)|  |

### Return type

[**\TNT\Amazon\VendorDirectFulfillmentShipping\V1\Model\SubmitShippingLabelsResponse**](../Model/SubmitShippingLabelsResponse.md)
