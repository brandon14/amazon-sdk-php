# TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\VendorShippingApi
...
# **getPackingSlip**
> \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\PackingSlip getPackingSlip($purchase_order_number)
...
$apiInstance = new TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Api\VendorShippingApi(
...
[**\TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\PackingSlip**](../Model/PackingSlip.md)
...
# **getPackingSlips**
> \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\PackingSlipList getPackingSlips($created_after, $created_before, $ship_from_party_id, $limit, $sort_order, $next_token)
...
[**\TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\PackingSlipList**](../Model/PackingSlipList.md)
...
> \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\TransactionReference submitShipmentConfirmations($body)
...
$body = new \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\SubmitShipmentConfirmationsRequest(); // \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\SubmitShipmentConfirmationsRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\SubmitShipmentConfirmationsRequest**](../Model/SubmitShipmentConfirmationsRequest.md)|  |
...
> \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\TransactionReference submitShipmentStatusUpdates($body)
...
$body = new \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\SubmitShipmentStatusUpdatesRequest(); // \TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\SubmitShipmentStatusUpdatesRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\TNT\Amazon\VendorDirectFulfillmentShipping\V20211228\Model\SubmitShipmentStatusUpdatesRequest**](../Model/SubmitShipmentStatusUpdatesRequest.md)|  |
