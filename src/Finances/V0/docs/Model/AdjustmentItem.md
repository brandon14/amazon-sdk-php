...
**per_unit_amount** | [**\TNT\Amazon\Finances\V0\Model\Currency**](Currency.md) | The per unit value of the item. | [optional] 
**total_amount** | [**\TNT\Amazon\Finances\V0\Model\Currency**](Currency.md) | The total value of the item. | [optional] 
